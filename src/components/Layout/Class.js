  ...
  return (
    <>
      <div id='classSection' className='jsutify-center mt-40'>
        <h1 data-aos='fade-down' className='text-black font-bold text-center tracking-wide text-5xl'>
          Class
        </h1>
        <div className='flex flex-col gap-10 justify-center items-center mt-20'>
          <div data-aos='fade-left' className='flex items-center justify-center gap-10'>
          ...
          <div data-aos='fade-right' className='flex items-center justify-center gap-10'>
