      ...
      <section className='max-w-7xl mx-auto justify-center items-center '>
        <div className='min-h-screen flex justify-center items-center'>
          <div className='w-full mx-auto justify-center items-center px-6 lg:px-0'>
            <img src='/IMG/logoall.png' className='mx-auto items-center justify-center mb-10 w-72 lg:w-auto' alt='logoall' />
            <div className='max-w-xl mx-auto h-auto rounded-3xl p-10 bg-gray-300 bg-opacity-10 shadow-xl justify-center items-center'>
              <form className='w-full'>
                ...
                <p className='text-gray-400 text-xl mb-8'>Login to see your dashboard</p>
                ...
                <button className='w-full bg-blue-800 text-white font-bold py-3 px-4 rounded text-2xl hover:bg-blue-700' onClick={loginHandle}>
                  Login
                </button>
              </form>
            </div>
